<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex gap-10 py-12">
    <div class="w-64">
        ...
        <ul>
            ...
            <li>
                {{-- slate : es color de pizarra --}}
                <a href="#" wire:click.prevent="filterByCategory('')" class="p-2 rounded-md flex bg-slate-800 item-center gap-2 text-white/60 hover:text-white font-semibold text-xs capitalize">
    ...
    <div class="w-full">
        ...
        @foreach ($threads as $thread)
            <div class="rounded-md bg-grandient-to-r from-slate-800 to-slate-900 hover:to-slate-800 mb-4">
